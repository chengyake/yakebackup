...
__kernel void process_iq(__global void *idata_v, __global void *rdata_v, __global void *sum_v, __global void *mid_v,  __global void *all_table_v ) {


    int i = get_global_id(0)*256 + get_global_id(1);

    __global int4 *table_i = idata_v;
