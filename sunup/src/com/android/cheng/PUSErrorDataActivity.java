    ...
    private BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver(){
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if(action.equals(ComService.ACTION_GET_PUS_ERROR)){
                ...
                Log.e("chengyake", "in PUSErrorActivity finish");
                finish();
            }
        }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        allerr.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
                t=0;
                dialog = new ProgressDialog(PUSErrorDataActivity.this); 
        ...
        errdel.setOnClickListener(new View.OnClickListener() {
            ...
            new AlertDialog.Builder(PUSErrorDataActivity.this)
            .setTitle("确定清除？")
