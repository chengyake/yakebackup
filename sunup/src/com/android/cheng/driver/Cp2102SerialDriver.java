package com.android.cheng.driver;
...
public class Cp2102SerialDriver extends CommonUsbSerialDriver {
    ...
    private static final int SILABSER_GET_LINE_CTL_REQUEST_CODE = 0x04;
    ...
    private int getConfigSingle(int paramInt, byte[] paramArrayOfByte)
    {
        return this.mConnection.controlTransfer(193, paramInt, 0, 0, paramArrayOfByte, paramArrayOfByte.length, 5000);
    }
        ...
        while (offset < src.length) {
            ...
            synchronized (mWriteBufferLock) {
                ...
                amtWritten = mConnection.bulkTransfer(mWriteEndpoint, writeBuffer, writeLength,
                        timeoutMillis);
                //Log.e("chengyake", "writeBuffer:" + " 0: " + writeBuffer[0] + " 1: " + writeBuffer[1] + " 2: " + writeBuffer[2] + " length:" + writeLength);
            }
            if (amtWritten <= 0) {
            ...
            //Log.d(TAG, "chengyake Wrote amt=" + amtWritten + " attempted=" + writeLength);
            offset += amtWritten;
        }
        return offset;
    }
