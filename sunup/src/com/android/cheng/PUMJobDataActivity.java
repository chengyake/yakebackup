...
public class PUMJobDataActivity extends Activity {
    ...
    class AddFileThread extends Thread {
        ...
        public void run() {
            ...
            intent1.setAction("PUMJobData_show_upload_dialog");
            ...
            intent3.setAction("PUMJobData_cancel_download_dialog");
            sendBroadcast(intent3);

            Intent intent2 = new Intent();
            intent2.setAction("PUMJobData_show_import_case");
    ...
    class DownloadThread extends Thread {
        ...
        public void run() {
            ...
            Intent intent1 = new Intent();
            intent1.setAction("PUMJobData_show_download_dialog");
            sendBroadcast(intent1);
    ...
    private BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver(){
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if(action.equals(ComService.ACTION_UPLOAD_PUM_JOBDATA)){
                ...
                for(i=(4*HexDump.hexStringToInt(mSize, 2)+16); i>=20; i-=4) {
                   ...
                   if(import_mode==1) {
                       ...
                       newvBuf.append(newv);
                       map.put("ItemNew", newvBuf.substring(2, 6));
                ...
                if(info.equals("2E414B00040001000100434D424D21") && dialog!=null) {
                    dialog.cancel(); 
                }
            } else if (action.equals("PUMJobData_show_download_dialog")) {
                    ...
                    dialog.show();    
            } else if (action.equals("PUMJobData_cancel_download_dialog")) {
                    dialog.cancel();
                    if(download_error==1) {
            ...
            } else if (action.equals("PUMJobData_show_upload_dialog")) {
                    dialog = new ProgressDialog(PUMJobDataActivity.this); 
                    dialog.setProgressStyle(ProgressDialog.STYLE_SPINNER); 
                    dialog.setTitle("PUM"); 
                    dialog.setMessage("正在导入数据..."); 
                    dialog.setIcon(android.R.drawable.ic_dialog_map); 
                    dialog.setIndeterminate(false); 
                    dialog.setCancelable(false);
                    dialog.show();   
            } else if (action.equals("PUMJobData_show_import_case") && importCase!=null) {
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		myIntentFilter.addAction("PUMJobData_show_download_dialog");
		myIntentFilter.addAction("PUMJobData_cancel_download_dialog");
		myIntentFilter.addAction("PUMJobData_show_import_case");
		myIntentFilter.addAction("PUMJobData_show_upload_dialog");
        ...
        list.setOnItemClickListener(new OnItemClickListener() {
            ...
            currentIF=arg2;
            listItemAdapter.setCurrent(currentIF);
            Log.e("chengyake", "--------------------------currentIF: " + currentIF);
            listItemAdapter.notifyDataSetChanged();
    ...
    private void downloadData() {
            ...
            if(keyBusy == true || mAddr == null || mSize == null || mAddr.equals("") || mSize.equals("") ) {
                download_error=1;
                Intent intent1 = new Intent();
                intent1.setAction("PUMJobData_cancel_download_dialog");
                sendBroadcast(intent1);
                return ;
            }
    ...
    private String importExcel(String file) {
        ...
        try {
            ...
            return "文件/sdcard/PUM500_DATA.xls不存在";
        }

        return "文件/sdcard/PUM500_DATA.xls导入完成";
    }
