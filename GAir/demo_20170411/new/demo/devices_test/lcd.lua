...
,{0x00, 0x00, 0x60, 0x60, 0x00, 0x00} -- 2e .   i=15
,{0x00, 0x20, 0x10, 0x08, 0x04, 0x02} -- 2f /
,{0x00, 0x3e, 0x51, 0x49, 0x45, 0x3e} -- 30 0   i=17
...
function display_temp(i1,i2,f1,f2)

      set_5110_xy(40, 4)
      for k, v in pairs(ascii_code[i1+17]) do
          write_byte(v,1);
      end
      for k, v in pairs(ascii_code[i2+17]) do
          write_byte(v,1);
      end
      for k, v in pairs(ascii_code[15]) do
          write_byte(v,1);
      end
      for k, v in pairs(ascii_code[f1+17]) do
          write_byte(v,1);
      end
      for k, v in pairs(ascii_code[f2+17]) do
          write_byte(0x00,1);
      end
      for k, v in pairs(sign[6]) do
          write_byte(v,1);
      end
end
...
function clear_temp()
      ...
      set_5110_xy(40, 4)
      for k, v in pairs(ascii_code[17]) do
          write_byte(0x00,1);
      end
      for k, v in pairs(ascii_code[17]) do
          write_byte(0x00,1);
...
function display_press(i1,i2,f1,f2)
      ...
      for k, v in pairs(ascii_code[15]) do          --point
          write_byte(v,1);
      end
      for k, v in pairs(ascii_code[f1+17]) do
          write_byte(v,1);
      ...
      for k, v in pairs(ascii_code[49]) do
          write_byte(v,1);
      end
      for k, v in pairs(ascii_code[66]) do
          write_byte(v,1);
      end
end
