...
#define RIL_ACM_AMM_DIG_LENGTH               6
#define RIL_PPU_DIGMAX_LENGTH                  21
#define RIL_COUNTRY_CODE_LENGTH                 3
#endif

#define PARCEL_LENGTH               200
typedef struct {
     int  request;
     int  token;
     int  responseType;
...
//Change this define when new RIL apis are added
#define RIL_MAX_REQUEST	RIL_REQUEST_SET_UNSOL_CELL_INFO_LIST_RATE
 ...
 * SIM card or in the active application in the UICC file EFACM.
 *
 * "data" is const char **
 * (const char *)data[0] indicate for "passwd"
 *
 * Valid errors:
 *  SUCCESS
 *  RADIO_NOT_AVAILABLE
 *  GENERIC_FAILURE
 */
#define RIL_REQUEST_SET_ACM   (RIL_REQUEST_EXT_BASE + 2)

/**
 * RIL REQUEST_GET_ACM
 *
 * read command to get the Advice of Charge related Accumulated Call Meter value in
 * SIM card or in the active application in the UICC file EFACM.
 *
 * "response" is char **
 * ((char **)response)[0] indicate string "acm".
 *
 * Valid errors:
 *  SUCCESS
 *  RADIO_NOT_AVAILABLE
 *  GENERIC_FAILURE
 */
#define RIL_REQUEST_GET_ACM   (RIL_REQUEST_EXT_BASE + 3)

/**
 * RIL_REQUEST_SET_AMM
 *
 * "data" is const char **
 * (const char *)data[0] indicate for "acmmax"
 * (const char *)data[1] indicate for "passwd"
 ...
 *  GENERIC_FAILURE
 */
#define RIL_REQUEST_SET_AMM (RIL_REQUEST_EXT_BASE + 4)

/*
 * RIL_REQUEST_GET_AMM
 *
 * "response" is char **
 * ((char **)response)[0] indicate for "acmmax"
 *
 * Valid errors:
 *  SUCCESS
 *  RADIO_NOT_AVAILABLE
 *  GENERIC_FAILURE
 */
#define RIL_REQUEST_GET_AMM (RIL_REQUEST_EXT_BASE + 5)

/*
 * RIL_REQUEST_SET_CPUC
 *
 * "data" is const char **
 * (const char *)data[0] indicate for "currency"
 * (const char *)data[1] indicate for "ppu"
 * (const char *)data[2] indicate for "passrd"
 *
 * Valid errors:
 *  SUCCESS
 *  RADIO_NOT_AVAILABLE
 *  GENERIC_FAILURE
 */
#define RIL_REQUEST_SET_CPUC  (RIL_REQUEST_EXT_BASE + 6)

/*
 * RIL_REQUEST_GET_CPUC
 *
 * "response" is char **
 * ((char **)response)[0] indicate for "currency"
 * ((char **)response)[1] indicate for "ppu"
 *
 * Valid errors:
 *  SUCCESS
 *  RADIO_NOT_AVAILABLE
 *  GENERIC_FAILURE
 */
#define RIL_REQUEST_GET_CPUC  (RIL_REQUEST_EXT_BASE + 7)


/*
 * RIL_REQUEST_FAST_DORMANCY
 *
 * "data" is NULL
 *
 * "response" is NULL
 ...
 *  GENERIC_FAILURE
 */
#define RIL_REQUEST_FAST_DORMANCY (RIL_REQUEST_EXT_BASE + 8)

/*
 * RIL_REQUEST_SELECT_BAND
 *
 * Select given band
 *
 * "data" is int *
 * ((int *)data)[0] is == 1 for GSM900
 * ((int *)data)[0] is == 2 for GSM850
 * ((int *)data)[0] is == 3 for PCS
 * ((int *)data)[0] is == 4 for DCS
 * ((int *)data)[0] is == 6 for GSM ONLY
 * ((int *)data)[0] is == 7 for WCDMA I
 * ((int *)data)[0] is == 8 for WCDMA II
 * ((int *)data)[0] is == 9 for WCDMA III
 * ((int *)data)[0] is == 10 for WCDMA IV
 * ((int *)data)[0] is == 11 for WCDMA V
 * ((int *)data)[0] is == 12 for WCDMA VI
 * ((int *)data)[0] is == 13 for WCDMA VII
 * ((int *)data)[0] is == 14 for WCDMA VIII
 * ((int *)data)[0] is == 15 for WCDMA VIIII
 * ((int *)data)[0] is == 16 for WCDMA X
 * ((int *)data)[0] is == 17 for WCDMA ONLY
 * ((int *)data)[0] is == 18 for Automatic
 *
 * "response" is NULL
 *
 * Valid errors:
 ...
 *  GENERIC_FAILURE
 */
#define RIL_REQUEST_SELECT_BAND (RIL_REQUEST_EXT_BASE + 9)

#define RIL_REQUEST_GET_BAND    (RIL_REQUEST_EXT_BASE + 10)
...
#define RIL_REQUEST_SET_NETWORK_SELECTION_MANUAL_EXT    (RIL_REQUEST_EXT_BASE + 11)
...
#define RIL_REQUEST_QUERY_COLP (RIL_REQUEST_EXT_BASE + 12)
 ...
 *  GENERIC_FAILURE
 */
#define RIL_REQUEST_SET_CLIP  (RIL_REQUEST_EXT_BASE + 13)
 ...
 *  GENERIC_FAILURE
 */
#define RIL_REQUEST_SET_COLP  (RIL_REQUEST_EXT_BASE + 14)
 ...
 *  GENERIC_FAILURE
 */
#define RIL_REQUEST_GET_CNAP (RIL_REQUEST_EXT_BASE + 15)
 ...
 *  GENERIC_FAILURE
 */
#define RIL_REQUEST_SET_CNAP  (RIL_REQUEST_EXT_BASE + 16)
...
#define RIL_REQUEST_QUERY_COLR (RIL_REQUEST_EXT_BASE + 17)
 ...
 *  GENERIC_FAILURE
 */
#define RIL_REQUEST_SET_COLR  (RIL_REQUEST_EXT_BASE + 18)
 ...
 *  GENERIC_FAILURE
 */
#define RIL_REQUEST_LOCK_INFO (RIL_REQUEST_EXT_BASE + 19)

/**
 *  "data" is a const RIL_SIM_IO *
 *  "response" is a const RIL_SIM_IO_Response *
 */
#define RIL_REQUEST_SIM_TRANSMIT_BASIC (RIL_REQUEST_EXT_BASE + 20)

/**
 * "data" is a const char * containing the AID of the applet
 * "response" is a int * containing the channel id
 */
#define RIL_REQUEST_SIM_OPEN_CHANNEL (RIL_REQUEST_EXT_BASE + 21)

/**
 * "data" is a const int * containing the channel id
 * "response" is NULL
 */
#define RIL_REQUEST_SIM_CLOSE_CHANNEL (RIL_REQUEST_EXT_BASE + 22)

/**
 * "data" is a const RIL_SIM_IO *
 * "response" is a const RIL_SIM_IO_Response *
 */
#define RIL_REQUEST_SIM_TRANSMIT_CHANNEL (RIL_REQUEST_EXT_BASE + 23)

/**
 * "data" in NULL
 * "response" is char*
 */
#define RIL_REQUEST_SIM_GET_ATR (RIL_REQUEST_EXT_BASE + 24)

/**
 * "data" is a const int *
 * ((int *)data)[0] is enable/disable fast dormancy
 * ((int *)data)[1] is timeout value of fast dormancy
 * "response" is NULL
 */
#define RIL_REQUEST_SET_FDY (RIL_REQUEST_EXT_BASE + 25)

/**
 * "data" is a const int *
 * ((int *)data)[0] is 0/1 indicate WB AMR is used in UMTS
 * ((int *)data)[1] is 0/1 indicate WB AMR is used in GSM
 * ((int *)data)[2] is vendor info
 * ((int *)data)[3] is menufacture info
 * "response" is NULL
 */
#define RIL_REQUEST_SET_COMCFG (RIL_REQUEST_EXT_BASE + 26)

/**
 * RIL_REQUEST_GET_COMCFG
 *
 * Queries the cp info
 *
 * "data" is a const int *
 * ((int *)data)[0] is a bitmap representing the cp info to get
 * (int *)response[0] is umts_wb_amr
 *                [1] is gsm_wb_amr
 *
 * Valid errors:
 *  SUCCESS
 ...
 *  GENERIC_FAILURE
 */
#define RIL_REQUEST_GET_COMCFG (RIL_REQUEST_EXT_BASE + 27)

/**
* RIL_REQUEST_SWITCH_MODEM
 *
 * "data" is int *
 * ((int *)data)[0] is modem type
 *
 * "response" is NULL
*/
#define RIL_REQUEST_SWITCH_MODEM (RIL_REQUEST_EXT_BASE + 28)

/**
 * RIL_REQUEST_GET_IMS_REGISTRATION_STATE
 *
 ...
 *  GENERIC_FAILURE
 */
#define RIL_REQUEST_GET_IMS_REGISTRATION_STATE (RIL_REQUEST_EXT_BASE + 29)

// change this definitions when adding more external ril requestes
#define RIL_REQUEST_EXT_LAST  (RIL_REQUEST_GET_IMS_REGISTRATION_STATE)
#endif
...
#define RIL_UNSOL_AT_STRING_IND  1037
...
/**
 * RIL_UNSOL_RESPONSE_IMS_STATE_CHANGED
 *
 ...
 *
 */
#define RIL_UNSOL_RESPONSE_IMS_STATE_CHANGED (RIL_UNSOL_RESPONSE_EXT_BASE + 5)
